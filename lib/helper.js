...
exports.createInsert = function (tbl, idField, _cfg) {
  ...
  return async function (rc, _opts) {
    ...
    cfg.defaultFields = (cfg.defaultFields) ? cfg.defaultFields : [];
    ...
    if (_.isPlainObject(cfg.defaultFields)) {
      rc = _.assignWith(rc, cfg.defaultFields, function(objVal, srcVal) {
